                ...
                <div class="column width-12 center">
                    <div class="title-container">
                        <div class="title-container-inner color-white">
                            <h1 class="title-xlarge font-alt-2 weight-light color-white mb-10">Edit Users</h1>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row flex">
                <div class="column width-12">
                    <div class="signup-form-container signup-box horizon" data-animate-in="preset:slideInLeftLong;duration:1000ms;">
                        ...
                        <form class="" method="post" action="/user/{{$user->id}}">
                            {{method_field('PATCH')}}
                            {{csrf_field()}}
                            <div class="row">
                                <div class="column width-6">
                                    <div class="field-wrapper">
                                        <input type="text" name="fname" class="form-name form-element large left" placeholder="First Name*" tabindex="2" value="{{$user->first_name}}">
                                    </div>
                                </div>
                                <div class="column width-6">
                                    <div class="field-wrapper">
                                        <input type="text" name="lname" class="form-name form-element large left" placeholder="Last Name*" tabindex="2" value="{{$user->last_name}}">
                                    </div>
                                </div>
                                <div class="column width-6">
                                    <div class="field-wrapper">
                                        <input type="email" name="email" class="form-email form-element large left" placeholder="Email address*" tabindex="2" value="{{$user->email}}">
                                    </div>
                                </div>
                                <div class="column width-6">
                                    <div class="field-wrapper">
